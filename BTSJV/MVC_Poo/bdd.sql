...
*/
drop database if exists alternanceBTSJV;
 
-- creation
 
create database alternanceBTSJV;
...
id_ent int auto_increment primary key,siret int,
nom_ent varchar(150),
...
-- SELECT : afficher/projeter le contenu d'une ou plusieurs table
/*
SELECT nomcolonne1, nomcolonne2, nomcolonne4 FROM nomTable1, nomTable2 WHERE condition;

SELECT * FROM nomTable;
*/
-- exemple : afficher tout le contenu de la table etudiant 
