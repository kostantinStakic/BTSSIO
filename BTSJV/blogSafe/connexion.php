...
<body>
	...
	<form method="POST" enctype="multipart/form-data">
		...
		value=<?php echo (isset($_GET['action']) && $_GET['action'] == "modif") ? $_GET['titre'] : "" ; ?>><br><br>
		<textarea name="contenu" cols="50" rows="10"><?php echo (isset($_GET['action']) && $_GET['action'] == "modif") ? $_GET['contenu'] : "" ; ?>
		</textarea><br><br>
...
<table border="1">
	...
	foreach ($resultat as $article) {
		...
		$nom_aut = $article['nom_aut'];
		$prenom_aut = $article['prenom_aut'];
		echo "	<tr>
					<td>".$titre."</td>
					<td>".$contenu."</td>
